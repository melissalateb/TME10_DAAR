...
class RedirectionListeDeProduits(APIView):
    def get(self, request, format=None):
        ...
        print("Response1 status code:", response.status_code)
...
class PromoList(APIView):
    def get(self, request, format=None):
        ...
        for prod in ProduitEnPromotion.objects.all():
            ...
            print("Response2 status code:", response.status_code)
...
class PromoDetail(APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        print("Response3 status code:", response.status_code)
        print("Response3 text:", response.text)
        return Response(jsondata)
#    def put(self, request, pk, format=None):
#        NO DEFITION of put --> server will return "405 NOT ALLOWED"
#    def delete(self, request, pk, format=None):
